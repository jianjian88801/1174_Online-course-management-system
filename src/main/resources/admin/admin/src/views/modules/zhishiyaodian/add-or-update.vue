<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="知识点名称" prop="zhishidianmingcheng">
          <el-input v-model="ruleForm.zhishidianmingcheng" 
              placeholder="知识点名称" clearable  :readonly="ro.zhishidianmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="知识点名称" prop="zhishidianmingcheng">
              <el-input v-model="ruleForm.zhishidianmingcheng" 
                placeholder="知识点名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="知识点内容" prop="zhishidianneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="知识点内容"
                  v-model="ruleForm.zhishidianneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhishidianneirong" label="知识点内容" prop="zhishidianneirong">
                    <span>{{ruleForm.zhishidianneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="知识点解析" prop="zhishidianjiexi">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.zhishidianjiexi" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhishidianjiexi" label="知识点解析" prop="zhishidianjiexi">
                    <span v-html="ruleForm.zhishidianjiexi"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	kemuleixing : false,
	zhishidianmingcheng : false,
	zhishidianneirong : false,
	zhishidianjiexi : false,
	kechengtupian : false,
	faburiqi : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kemuleixing = true;
          ...
          if(o=='zhishidianmingcheng'){
            this.ruleForm.zhishidianmingcheng = obj[o];
	    this.ro.zhishidianmingcheng = true;
            continue;
          }
          if(o=='zhishidianneirong'){
            this.ruleForm.zhishidianneirong = obj[o];
	    this.ro.zhishidianneirong = true;
            continue;
          }
          if(o=='zhishidianjiexi'){
            this.ruleForm.zhishidianjiexi = obj[o];
	    this.ro.zhishidianjiexi = true;
            continue;
          }
          if(o=='kechengtupian'){
	...
	this.ruleForm.zhishidianjiexi = this.ruleForm.zhishidianjiexi.replace(reg,'../../../springboot0b6e5/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zhishiyaodian/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhishiyaodianCrossAddOrUpdateFlag = false;
                  this.parent.search();
